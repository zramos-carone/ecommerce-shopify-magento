          ...
          <div className="lg:col-span-8">
            <AnimatePresence mode="popLayout">
              {!cart || cart.length === 0 ? (
                ...
                >
                  ...
                  <h2 className="text-2xl font-black text-gray-900 mb-2 font-outfit">
                    TU CARRITO ESTÁ VACÍO
                  </h2>
                  <p className="text-gray-500 mb-8 max-w-xs mx-auto text-sm leading-relaxed">
                    Parece que aún no has agregado nada. La potencia de{" "}
                    {BRAND_CONFIG.shortName}
                    {BRAND_CONFIG.accentName} te espera.
                  </p>
                  <Link
                    href="/catalog"
            ...
            <div className="mt-8 p-8 rounded-[2rem] bg-gray-900 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                  <h3 className="text-xl font-black font-outfit mb-2">
                    ¿Necesitas ayuda con tu pedido?
                  </h3>
                  <p className="text-sm text-gray-400">
                    Nuestros expertos están listos para asesorarte en tu
                    configuración.
                  </p>
                </div>
