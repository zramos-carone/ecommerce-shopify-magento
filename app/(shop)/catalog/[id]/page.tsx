    ...
    const fetchProduct = async () => {
      try {
        ...
        const found = data.products.find(
          (p: MayoristaProduct) => p.id === productId,
        );
      ...
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 font-medium animate-pulse">
            Cargando experiencia {BRAND_CONFIG.shortName}
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white p-4 text-center">
        ...
        <p className="text-gray-500 mb-6">
          Lo sentimos, el producto que buscas no está disponible actualmente.
        </p>
        <button
          ...
          >
            ...
            <div className="bg-gray-50 rounded-[2rem] p-8 border border-gray-100 mb-10">
              ...
              <p className="text-xs font-medium text-gray-500 mb-6">
                IVA incluido • Envío calculado al checkout
              </p>
              ...
              <div className="flex items-center space-x-2 mb-8">
                {product.inStock ? (
                  <>
                    ...
                    <span className="text-sm font-bold text-green-600 uppercase tracking-tight">
            ...
            <div className="border-t border-gray-100 pt-10">
              <h3 className="text-lg font-black text-gray-900 font-outfit uppercase tracking-tighter mb-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    label: "Mayorista",
                    value: product.mayorista.toUpperCase(),
                  },
            ...
            <div className="mt-10 p-6 rounded-[2rem] bg-gradient-to-br from-blue-600 to-blue-800 text-white relative overflow-hidden group">
              ...
              <p className="text-sm font-black uppercase tracking-widest mb-2 flex items-center">
                ...
                {BRAND_CONFIG.accentName} Assurance
              </p>
              <h4 className="text-xl font-black font-outfit mb-2">
                Soporte Técnico Especializado
              </h4>
              <p className="text-sm text-blue-100 leading-relaxed">
                Todos nuestros productos cuentan con soporte directo. ¿Tienes
                dudas? Nuestros expertos te acompañan en la configuración.
              </p>
            </div>
          </motion.div>
        </div>
