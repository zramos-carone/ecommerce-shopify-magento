    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white p-4">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-black font-outfit uppercase tracking-tighter mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <CreditCard
                        className={`w-6 h-6 ${formData.paymentMethod === "credit_card" ? "text-blue-600" : "text-gray-400"}`}
                      />
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <Wallet
                        className={`w-6 h-6 ${formData.paymentMethod === "paypal" ? "text-blue-600" : "text-gray-400"}`}
                      />
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24">
            <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm overflow-hidden">
              <h3 className="text-xl font-black font-outfit uppercase tracking-tighter mb-8 pb-4 border-b border-gray-50">
                Tu Pedido
              </h3>
              ...
              <div className="space-y-3 pt-6 border-t border-gray-50">
                ...
                <div className="flex justify-between items-end pt-4 mt-2">
                  <span className="text-base font-black font-outfit uppercase tracking-tighter">
                    Total Final
                  </span>
                  <span className="text-3xl font-black text-blue-600 font-outfit leading-none">
