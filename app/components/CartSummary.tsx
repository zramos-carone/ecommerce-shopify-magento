...
export function CartSummary({ items, onCheckout }: CartSummaryProps) {
  ...
  return (
    <div className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
      <h2 className="text-xl font-black text-gray-900 mb-6 font-outfit uppercase tracking-tighter">
        Resumen de Compra
      </h2>
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="flex justify-between items-center border-t border-gray-100 pt-6">
          <span className="text-base font-black text-gray-900 uppercase tracking-tighter font-outfit">
            Total Final
          </span>
      ...
      <div className="space-y-3 mb-8">
        ...
        <div className="flex items-center space-x-3 text-[10px] text-gray-400 font-bold uppercase tracking-widest bg-gray-50 p-3 rounded-xl border border-gray-100">
          ...
          <span>
            Compra Protegida {BRAND_CONFIG.shortName}
